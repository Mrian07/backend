...
<div class="upload-content">
    ...
    <form class="form-horizontal" id="frm6" method="post" enctype="multipart/form-data" action="driver_document_action.php?id=<?php echo $id[1] ; ?>&master=<?php echo $id[0] ; ?> " name="frm6">
        ...
        <div class="form-group">
            <div class="col-lg-12">
                <div class="fileupload fileupload-new" data-provides="fileupload">
                    <div class="fileupload-preview thumbnail" style="width: 100%; height: 150px; ">
                        <?php if ($db_user[0]['doc_file'] == '') { 
                            ...
                            if ($file_ext == 'is_image') {
                                ...
                                <img src = "<?= $tconfig["tsite_upload_driver_doc"]. '/' . $id[1] . '/' . $db_user[0]['doc_file'] ?>" style="width:100%;" alt ="Licence not found"/>
                            <?php } else { 
                    ...
                    <div>
                        <span class="btn btn-file btn-success"><span class="fileupload-new">Upload <?php echo $vName ?> Photo</span>
