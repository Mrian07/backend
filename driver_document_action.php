                                            ...
                                            <div class="panel-body">
                                                <?php if ($db_userdoc[$i]['doc_file'] != '') { ?>
                                                    ...
                                                    if ($file_ext == 'is_image') {
                                                        ?>
                                                        <span><img src = "<?= $tconfig["tsite_upload_driver_doc"] . '/' . $id . '/' . $db_userdoc[$i]['doc_file'] ?>" style="width:200px;cursor:pointer;" alt ="<?= $db_userdoc[$i]['d_name']; ?> Image" data-toggle="modal" data-target="#myModallicence"/></span>
