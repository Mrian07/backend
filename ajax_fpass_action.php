	...
	if($action == 'driver')
	{
		...
		if(count($db_login)>0)
		{
			if(SITE_TYPE != 'Demo'){
					...
					$maildata['LINK'] = "<a href='".$url."'><button style='border: none;background: #867adb;color: #fff;padding: 8px 10px;margin-top: 10px;cursor: pointer;'>Click here to reset password</button></a>";
