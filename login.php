...
<!-- PAGE CONTENT -->
<div class="container">
  <div class="text-center"> <a href="index.php"> <img src="<?=$tconfig['tsite_img'];?>/logo.png" id="<?=$SITE_NAME?>" alt=" <?=$SITE_NAME?>" /> </a> </div>
  <div class="sign-in-heading" >
    <h3><?=$langage_lbl['LBL_DRIVERLOGIN_LOGIN']; ?></h3>
  </div>
  <div class="tab-content">
    <div id="login" class="tab-pane active">
      <form action="index.html" class="form-signin2 form-login">
        <a href = "login_new.php?action=rider"><?=$langage_lbl['LBL_LOGIN_AS_A_RIDER']; ?></a> <a href = "login_new.php?action=driver" class="login-option-2"><?=$langage_lbl['LBL_LOGIN_AS_A_DRIVER']; ?></a><br>
      </form>
    </div>
  </div>
</div>
