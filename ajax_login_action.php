...
if($action == 'driver')
{
	...
	$sql = "SELECT iDriverId,vCompany, iCompanyId, vName, vLastName, vEmail, vPhone,eStatus, vCurrencyDriver,vPassword FROM register_driver WHERE (vEmail = '".$email."' OR vPhone = '".$email."')";
...
{
	$tbl = 'register_user';
	$fields = 'iUserId, vName, vEmail, eStatus, vCurrencyPassenger, vPhone,vPassword';
