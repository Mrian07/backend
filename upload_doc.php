...
echo $action = isset($_REQUEST['action']) ? $_REQUEST['action'] : '';
// if(SITE_TYPE=='Demo')
// {
...
if ($action == 'noc') {
    ...
    if ($image_name != "") {
        ...
        if ($ext != "jpg" && $ext != "gif" && $ext != "png" && $ext != "jpeg" && $ext != "bmp" && $ext != "doc" && $ext != "docx" && $ext != "pdf") {
            $flag_error = 1;
            $var_msg = "You have selected wrong file format for Image. Valid formats are jpg,jpeg,gif,png,doc,docx,pdf";
        }
        /* else if($_FILES['noc']['size'] > 1048000) {
          $flag_error = 1;
...
if ($action == 'certi') {
    ...
    if ($image_name != "") {
        ...
        if ($ext != "jpg" && $ext != "gif" && $ext != "png" && $ext != "jpeg" && $ext != "bmp" && $ext != "doc" && $ext != "docx" && $ext != "pdf") {
            ...
            $var_msg = "You have selected wrong file format for Image. Valid formats are jpg,jpeg,gif,png,bmp,doc,docx";
        }
