...
if($keyword != ''){
    if($option != '') {
        ...
        $ssql.= " AND f.vTitle_EN LIKE '%".$keyword."%' OR f.iFaqcategoryId LIKE '%".$keyword."%' OR f.iDisplayOrder LIKE '%".$keyword."%' OR f.eStatus LIKE '%".$keyword."%'";
        //$ssql.= " AND vTitle_EN LIKE '%".$keyword."%' ";
    }
}
...
/* echo $sql = "SELECT f.*, fc.vTitle cat_name FROM ".$tbl_name." f, faq_categories fc WHERE f.iFaqcategoryId = fc.iUniqueId AND fc.vCode = '".$default_lang."' ORDER BY f.iFaqcategoryId, f.iDisplayOrder $ssql $ord"; */
//echo '1--';
...
{  //echo '2--';
	//echo $sql = "SELECT f.*, fc.vTitle cat_name FROM ".$tbl_name." f, faq_categories fc WHERE f.iFaqcategoryId = fc.iUniqueId AND fc.vCode = '".$default_lang."' ORDER BY f.iFaqcategoryId, f.iDisplayOrder ";
            ...
            <div id="content">
                <div class="inner">
                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                          ...
                                          <option value="f.vTitle_EN" <?php if ($option == "f.vTitle_EN") { echo "selected"; } ?> >Title</option>
                                    ...
                                    <td width="12%">
                                      ...
                                      <input type="button" value="Reset" class="btnalt button11" onClick="window.location.href='faq.php'"/>
                                    </td>
                                    <td width="30%"><a class="add-btn" href="faq_action.php" style="text-align: center;">Add FAQ</a></td>
                                </tr>
                              </tbody>
                        </table>
                                ...
                                <div class="admin-nir-export">
                                    ...
                                    <div class="panel-heading">
                                        <form name="_export_form" id="_export_form" method="post" >
                                            <button type="button" onclick="showExportTypes('faq')" >Export</button>
                                        </form>
                                   </div>
                                    </div>
                                    <div style="clear:both;"></div>
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    <?php //echo '=====>'.$count_all = count($data_drv);
													//echo '<pre>--->';print_r($data_drv);
                                                    ...
                                                    <tr class="gradeA">
                                                        <td align="center" style="text-align:center;"><input type="checkbox" id="checkbox" name="checkbox[]" <?php echo $default; ?> value="<?php echo $data_drv[$i]['iFaqId']; ?>" />&nbsp;</td>
														
                                                        
                                                        <td><?=$data_drv[$i]['vTitle_EN']; ?></td>
                                                        ...
                                                        <td align="center" style="text-align:center;">
                                                            ...
                                                            <td align="center" style="text-align:center;" class="action-btn001">
                                                                <div class="share-button openHoverAction-class" style="display: block;">
                                                                    ...
                                                                    <div class="social show-moreOptions openPops_<?= $data_drv[$i]['iFaqId']; ?>">
                                                                        <ul>
                                                                            <li class="entypo-twitter" data-network="twitter"><a href="faq_action.php?id=<?= $data_drv[$i]['iFaqId']; ?>&faq_cat_id=<?=$iFaqcategoryId;?>" data-toggle="tooltip" title="Edit">
                                                                                <img src="img/edit-icon.png" alt="Edit">
                                                                            </a></li>
                                                                            <?php if ($data_drv[$i]['eDefault'] != 'Yes') { ?>
                                                                            <li class="entypo-facebook" data-network="facebook"><a href="javascript:void(0);" onclick="changeStatus('<?php echo $data_drv[$i]['iFaqId']; ?>','Inactive')"  data-toggle="tooltip" title="Make Active">
                                                                                <img src="img/active-icon.png" alt="<?php echo $data_drv[$i]['eStatus']; ?>" >
                                                                            </a></li>
                                                                            <li class="entypo-gplus" data-network="gplus"><a href="javascript:void(0);" onclick="changeStatus('<?php echo $data_drv[$i]['iFaqId']; ?>','Active')" data-toggle="tooltip" title="Make Inactive">
                                                                                <img src="img/inactive-icon.png" alt="<?php echo $data_drv[$i]['eStatus']; ?>" >	
                                                                            </a></li>
                                                                            <li class="entypo-gplus" data-network="gplus"><a href="javascript:void(0);" onclick="changeStatusDelete('<?php echo $data_drv[$i]['iFaqId']; ?>')"  data-toggle="tooltip" title="Delete">
                    ...
                    <div class="admin-notes">
                            ...
                            <ul>
                                    <li>
                                            FAQ module will list all faqs on this page.
                                    </li>
                                    <li>
