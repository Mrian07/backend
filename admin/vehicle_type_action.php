...
if (isset($_POST['btnsubmit'])) {
    ...
    if (isset($_FILES['vLogo']) && $_FILES['vLogo']['name'] != "") {
        ...
        if ($width != 360 && $height != 360 && $flag_error == 0) {
    ...
    if (count($db_data) > 0) {
        for ($i = 0; $i < count($db_master); $i++) {
            ...
            foreach ($db_data as $key => $value) {
                ...
                $fVisitFee = $value['fVisitFee'];
                $iCancellationTimeLimit = $value['iCancellationTimeLimit'];
                $fCancellationFare = $value['fCancellationFare'];
                                ...
                                <?php if ($APP_TYPE == 'UberX') { ?> 
									...
									<div class="row">
									 ...
									 <div class="col-lg-6">
										  <select class="form-control" name = 'iCountryId' id="iCountryId" onChange="setState(this.value,'');" >
											   ...
											   <option value = "<?= $db_country[$i]['iCountryId'] ?>" <?if($iCountryId==$db_country[$i]['iCountryId']){?>selected<? } ?>><?= $db_country[$i]['vCountry'] ?></option>
											   <? } ?>
										  </select>
									 </div>
									</div>
                                    ...
                                    <div id="Regular_div1">
                                        ...
                                        <div class="row" id="hide-km">
                                            <div class="col-lg-12">
                                                <label> Price Per <em id="change_eUnit" style="font-style: normal"><?=$DEFAULT_DISTANCE_UNIT;?></em><span class="red"> *</span></label>
                                            </div>
                                            <div class="col-lg-6">
									...
									<div class="row">
											 <div class="col-lg-12">
												  <label> Passenger Cancellation Time Limit ( in minute )<span class="red"></span> <i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title='Passenger cancellation time limit for collecting charge from passenger, if cancel after the define time in minute.'></i></label>
											 </div>
											 <div class="col-lg-6">
									...
									<div class="row">
											 <div class="col-lg-12">
												  <label> Passenger Cancellation Charges<span class="red"></span> <i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title='Passenger cancellation charges will be apply to the passenger when passenger cancels ride.'></i></label>
											 </div>
											 <div class="col-lg-6">
