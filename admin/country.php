...
$sql = "SELECT COUNT(iCountryId) AS Total FROM country WHERE eStatus != 'Deleted' $ssql";
                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                          ...
                                          <?php /*<option value="vCountryCodeISO_3" <?php if ($option == 'vContactNo') {echo "selected"; } ?> >ISO_3 Code</option> */ ?>
