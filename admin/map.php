	...
	<div id="content">
		 ...
		 <div class="map-color-code">
			<ul>
			  <li> <a href="javascript:void(0);" onClick="setNewDriverLocations('Active','set1')"><img src="../assets/img/red.png">
				<h2>
				  <button role="button" class="btn btn-default setclass" id="set1"><?php echo $langage_lbl['LBL_ENROUTE_TO'];?></button>
				</h2>
				</a> </li>
			  <li> <a  href="javascript:void(0);" onClick="setNewDriverLocations('Arrived','set2')"><img src="../assets/img/blue.png">
				<h2>
				  <button role="button" class="btn btn-default setclass" id="set2"><?php echo $langage_lbl['LBL_REACHED_PICKUP'];?></button>
				</h2>
				</a> </li>
			  <li> <a href="javascript:void(0);" onClick="setNewDriverLocations('On Going Trip','set3')"><img src="../assets/img/yellow.png">
				<h2>
				  <button role="button" class="btn btn-default setclass" id="set3"><?php echo $langage_lbl['LBL_JOURNEY_STARTED'];?></button>
				</h2>
				</a> </li>
			  <li> <a href="javascript:void(0);" onClick="setNewDriverLocations('Available','set4')"><img src="../assets/img/green.png">
				<h2>
				  <button role="button" class="btn btn-default setclass"  id="set4">
			  ...
			  <li> <a href="javascript:void(0);" onClick="setNewDriverLocations('','set5')">
				<h2>
				  <button role="button" class="btn raised setclass active" id="set5"><?php echo $langage_lbl['LBL_ALL'];?></button>
				</h2>
				</a> </li>
			</ul>
		</div>
	  <div class="map-main-page-inner">
        <div class="map-main-page-inner-tab">
          <h3><a href="javascript:void(0);" class="active">Available</a>
            <!--a href="#">Busy</a-->
          </h3>
          <span>
          <input name="" type="text" placeholder="Search driver" onKeyUp="get_drivers_list(this.value)">
          </span>
          <ul id="driver_main_list" style="display:none">
            <!--li>
              <label class="map-tab-img">
              <label class="map-tab-img1"><img src=""></label>
              <img src="">
              </label>
              <p>demo<b>+4987979749646946</b></p>
            </li>
            <li >
              <label class="map-tab-img">
              <label class="map-tab-img1"><img src=""></label>
