...
if($keyword != ''){
    if($option != '') {
        ...
        $ssql.= " AND vSubject_$default_lang LIKE '%".$keyword."%' ";
    }
}
...
$sql = "SELECT COUNT(iEmailId) AS Total FROM email_templates WHERE eStatus != 'Deleted' $ssql";
...
//$sql = "SELECT * FROM ".$tbl_name."  WHERE eStatus != 'Deleted' $ssql $ord LIMIT $start, $per_page ";
 $sql = "SELECT * FROM ".$tbl_name." WHERE eStatus = 'Active' $ssql $ord LIMIT $start, $per_page ";
...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8" />
        <title><?=$SITE_NAME;?> | Email Template</title>
            ...
            <div id="content">
                <div class="inner">
                    <div id="add-hide-show-div">
                        <div class="row">
                            <div class="col-lg-12">
                                <h2><?php echo $langage_lbl_admin['LBL_EMAIL_TEMPLATE_ADMIN'];?></h2>
                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                          ...
                                          <option  value="<?='vSubject_'.$default_lang?>" <?php if ($option == "vSubject_$default_lang") { echo "selected"; } ?> >Email Templates</option>
                                    ...
                                    <td width="12%">
                                      ...
                                      <input type="button" value="Reset" class="btnalt button11" onClick="window.location.href='email_template.php'"/>
                                    </td>
                                ...
                                <div class="admin-nir-export">
                                    ...
                                    <div class="panel-heading">
                                        <form name="_export_form" id="_export_form" method="post" >
                                            <button type="button" onclick="showExportTypes('email_template')" >Export</button>
                                        </form>
                                   </div>
                                    </div>
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th width="20%"><a href="javascript:void(0);" onClick="Redirect(1,<?php if($sortby == '1'){ echo $order; }else { ?>0<?php } ?>)">Email Templates <?php if ($sortby == 1) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
                                                        
                                                        
                                                        
                                                        <th width="8%" align="center" style="text-align:center;"><a href="javascript:void(0);" onClick="Redirect(4,<?php if($sortby == '4'){ echo $order; }else { ?>0<?php } ?>)">Edit <?php if ($sortby == 4) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
                                                        ...
                                                        <td><?= $data_drv[$i]['vSubject_'.$default_lang]; ?></td>
                                                            ...
                                                            <td align="center" style="text-align:center;" class="action-btn001">
                                                                <!--<div class="share-button openHoverAction-class" style="display: block;">
                                                                    <label class="entypo-export"><span><a href="page_action.php?id=<?= $data_drv[$i]['iEmailId']; ?>" data-toggle="tooltip" title="Edit">
                                                                                <img src="img/edit-icon.png" alt="Edit">
                                                                            </a></span></label>
                                                                    <div class="social show-moreOptions openPops_<?= $data_drv[$i]['iEmailId']; ?>">
																...
																<div class="share-button openHoverAction-class" style="display: block;">
																	...
																	<label class="entypo-twitter" data-network="twitter"><a href="email_template_action.php?id=<?= $data_drv[$i]['iEmailId']; ?>" data-toggle="tooltip" title="Edit">
                                                                                <img src="img/edit-icon.png" alt="Edit">
                                                                            </a></label>
                                                                    <div class="social show-moreOptions openPops_<?= $data_drv[$i]['iEmailId']; ?>">
                                                                        <!--<ul>-->	<!-- </ul>-->
                    ...
                    <div class="admin-notes">
                            ...
                            <ul>
                                    <li>
                                            Email Templates module will list all emails on this page.
                                    </li>
                                    <li>
