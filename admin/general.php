													...
													<div class="row">
														...
														?>
															<div class="form-group">
																<label><?=$value1['tDescription']?><?php if($value1['tHelp']!=""){?> <i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title='<?=$value1['tHelp']?>'></i><?php }?></label>
																<?php
																	
																	if($value1['eInputType'] == 'Textarea') {
																?>
																	<textarea class="form-control" required rows="5" name="Data[<?=$value1['vName']?>]"><?=$value1['vValue']?></textarea>
																<?php
																	}
																...
																?>
																	<input type="text" name="Data[<?=$value1['vName']?>]" class="form-control" value="<?=$value1['vValue']?>" required>
																<?php
																	}
													...
													<div class="row">
														<div class="col-lg-12">
															<div class="form-group" style="text-align: center;">
																<button class="btn btn-primary save-configuration" type="submit">Save Configuration</button>
															</div>
														</div>
													</div>
												</form>
