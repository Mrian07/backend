							...
							<form method="post" action="" enctype="multipart/form-data">
								...
								<div class="row">
									...
									<div class="col-lg-6">
										<?
											$temp = 1;
											$query1 = mysql_query("SELECT iSortId FROM ".$tbl_name." WHERE 1=1 ORDER BY iSortId")or die(mysql_error());
											$dataArray = array();
																						
											while($res = mysql_fetch_array($query1)) 
											{
												$dataArray[] = $res['iSortId'];
												$temp = $iDisplayOrder;
											}
								...
								<? } else{ ?>
										<div class="row">
											...
											<div class="col-lg-6">
												<?
												$temp = 1;
												$query1 = mysql_query("SELECT max(iSortId) as MAXDORDER FROM ".$tbl_name."  ORDER BY iSortId")or die(mysql_error());
												$dataArray = array();
												while($res = mysql_fetch_array($query1))
												{
