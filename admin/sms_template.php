...
$ord = ' ORDER BY iSMSId DESC';
	
if($sortby == 1){
  if($order == 0)
  $ord = " ORDER BY vSMS_Code ASC";
  else
  $ord = " ORDER BY vSMS_Code DESC";
}
...
if($keyword != ''){
    if($option != '') {
        ...
        $ssql.= " AND vSMS_Code LIKE '%".$keyword."%' ";
    }
}
...
$sql = "SELECT COUNT(iSMSId) AS Total FROM sms_templates WHERE eStatus != 'Deleted' $ssql";
                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                          ...
                                          <option  value="<?='vSMS_Code'?>" <?php if ($option == "vSMS_Code") { echo "selected"; } ?> >SMS Templates</option>
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th width="20%"><a href="javascript:void(0);" onClick="Redirect(1,<?php if($sortby == '1'){ echo $order; }else { ?>0<?php } ?>)">SMS Templates <?php if ($sortby == 1) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
                                                          ...
                                                          <td align="center" style="text-align:center;" class="action-btn001">
																...
																<div class="share-button openHoverAction-class" style="display: block;">
																	...
																	<label class="entypo-twitter" data-network="twitter" style="margin-top: -10px;">
																			<a href="sms_template_action.php?id=<?= $data_drv[$i]['iSMSId']; ?>" data-toggle="tooltip" title="Edit">
                                                                                <img src="img/edit-icon.png" alt="Edit">
                                                                            </a></label>
																    <div class="social show-moreOptions openPops_<?= $data_drv[$i]['iSMSId']; ?>">
                                                                        <!--<ul>-->	<!-- </ul>-->
