...
$ord = ' ORDER BY LanguageLabelId DESC';
if($sortby == 1){
  if($order == 0)
...
$sql = "SELECT COUNT(LanguageLabelId) AS Total FROM ".$tbl_name." WHERE vCode = '".$default_lang."' $ssql";
        ...
        <div id="wrap">
            ...
            <div id="content">
                <div class="inner">
					...
					<div >
					<h3>Easy editing will be unable after clicking on the following platforms.</h3>
					<p>1. <?php if(!isset($_SESSION['sess_editingToken'])){ ?><a href="easy_editing_save.php?type=enable&platform=web">Click here to enable for website</a>
					<?php }else { ?>
						<a href="easy_editing_save.php?type=disable&platform=web">Click here to disable for website</a> ( <a href="<?php echo $tconfig['tsite_url']; ?>" target="_blank">Go to website</a> )
					<?php } ?>
					</p>
					<p>2. <a href="easy_editing_save.php?type=enable&platform=android">Click here to enable for android</a></p>
					<p>3. <a href="easy_editing_save.php?type=enable&platform=ios">Click here to enable for IOS</a></p>
					</div>
                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                          ...
                                          <option value="vValue" <?php if ($option == 'vValue') {echo "selected"; } ?> >Value In English Language</option>
                                    ...
                                    <td width="30%"><a class="add-btn" href="languages_action.php" style="text-align: center;">Add Label</a></td>
                                </tr>
                              </tbody>
                        </table>
                                                            ...
                                                            <td align="center" style="text-align:center;" class="action-btn001">
                                                                <div class="share-button openHoverAction-class" style="display: block;">
                                                                    ...
                                                                    <div class="social show-moreOptions openPops_<?= $data_drv[$i]['LanguageLabelId']; ?>">
                                                                        <ul>
                                                                            <li class="entypo-twitter" data-network="twitter"><a href="languages_action.php?id=<?= $data_drv[$i]['LanguageLabelId']; ?>" data-toggle="tooltip" title="Edit">
