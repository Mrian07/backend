...
if (isset($_POST['btnsubmit'])) {
    ...
    // $obj->sql_query($query);
    header("Location:document_master_add.php?id=" . $id . '&success=1');
}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <select id="country"  class="form-control" name = 'country'  required >
											...
											<?php 
												// country 
												$sql = "SELECT iCountryId,vCountry FROM country ORDER BY iCountryId ASC";
												$db_data1= $obj->MySQLSelect($sql);
												foreach ($db_data1 as $value) { ?>
												<option <?php if($db_data[0]['country'] == $value['iCountryId']){ echo 'selected';}?> value="<?php echo $value['iCountryId']; ?>"><?php echo $value['vCountry']; ?></option>
                                            <?php }?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <label>Document Name <span class="red"> *</span> 
                                            <i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title='Name of Document. Like, Insurance, Driving Licence.'></i>
...
if ($count_all > 0) {
    for ($i = 0; $i < $count_all; $i++) {
        ...
        ?>
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <label><?php echo $langage_lbl_admin['LBL_DOCUMENT_TYPE']; ?> (<?= $vTitle; ?>) <span class="red"> *</span></label>
