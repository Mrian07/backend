				...
				<div id="login" class="tab-pane active">				
					...
					<div class="admin-home-tab">
						<ul class="nav nav-tabs">
							<li class="active" onClick="setCredentials('1', '<?=SITE_TYPE;?>')"><a data-toggle="tab" href="#super001">Super Administrator</a></li>
							<li onClick="setCredentials('2', '<?=SITE_TYPE;?>');"><a data-toggle="tab" href="#dispatch001">Dispatcher Administrator</a></li>
							<li onClick="setCredentials('3', '<?=SITE_TYPE;?>');"><a data-toggle="tab" href="#billing001">Billing Administrator</a></li>
						</ul>
						<form action="" class="form-signin" method = "post" id="login_box" onSubmit="return chkValid();">
							<br>
							<b><label>E-mail</label>
					...
					var request = $.ajax({
						...
						{// alert(data);
							...
							if(dataHTml == 1){
								...
								if(hdf_class!="")
								{
									window.location = "http://192.168.1.131/cubetaxidev/admin/languages.php";
								}
								else
								{
									if(testLink == "") {
