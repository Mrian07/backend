...
//die;
	...
	if (isset($_POST['submit'])) {
		...
		$validobj->add_fields($_POST['iDriverId'], 'req', 'Driver is required.');
	...
	if ($error) {
		...
		if ($action == "Add") {
            $_SESSION['success'] = '1';
            $_SESSION['var_msg'] = 'Taxi Inserted Successfully.';
        } else {
            $_SESSION['success'] = '1';
            $_SESSION['var_msg'] = 'Taxi Updated Successfully.';
        }
					...
					<div class="body-div">
						<div class="form-group">
							...
							<div class="row">
								...
								<div class="row">
                                    <div class="col-lg-12">
                                        <input type="submit" class="btn btn-default" name="submit" id="submit" value="<?= $action; ?> Taxi" >
