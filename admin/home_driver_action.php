...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
	...
	<head>
		<meta charset="UTF-8" />
		<title>Admin | Home Page Driver  <?=$action;?></title>
							...
							<form method="post" action="" enctype="multipart/form-data" id="home_driver_action" name="home_driver_action">
								...
								<div class="row">
									...
									<div class="col-lg-6">
										<?
											$temp = 1;
											$query1 = mysql_query("SELECT iDisplayOrder FROM ".$tbl_name." ORDER BY iDisplayOrder")or die(mysql_error());
											$dataArray = array();
								...
								if($count_all > 0) {
									...
									<div class="col-lg-12">
                                        <input type="submit" class="btn btn-default" name="submit" id="submit" value="<?= $action; ?> Home Page Driver" >
