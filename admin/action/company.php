...
if ($method == 'delete' && $iCompanyId != '') {
	if(SITE_TYPE !='Demo'){
            ...
            // $query = "UPDATE company SET eStatus = 'Deleted' WHERE iCompanyId = '" . $iCompanyId . "'";
            // $obj->sql_query($query);
            #### add on 26-07-2017 #########
             ...
             if($res1==1)
             {
              $qur2 = "DELETE FROM company WHERE company.iCompanyId=$iCompanyId ";
...
//        $obj->sql_query($query);
//        $_SESSION['success'] = '1';
//        $_SESSION['var_msg'] = "Company " . $status . " Successfully.";
//        header("Location:".$tconfig["tsite_url_main_admin"]."company.php?".$parameters);
//        exit;
//    } else {
//        $_SESSION['success']=2;
