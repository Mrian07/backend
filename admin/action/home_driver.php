...
if ($iDriverId != '' && $status != '') {
	if(SITE_TYPE !='Demo'){
            ...
            $_SESSION['success'] = '1';
            if($status == 'Active') {
                   $_SESSION['var_msg'] = 'Home Page Driver activated successfully.';
            }else {
                   $_SESSION['var_msg'] = 'Home Page Driver inactivated successfully.';
            }
	}
	else{
            $_SESSION['success']=2;
...
if($checkbox != "" && $statusVal != "") {
	if(SITE_TYPE !='Demo'){
		 ...
		 $obj->sql_query($query);
		 $_SESSION['success'] = '1';
		 $_SESSION['var_msg'] = 'Home Page Driver(s) updated successfully.';
	}
	else{
		$_SESSION['success']=2;
	}
