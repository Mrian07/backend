...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8" />
        <title><?=$SITE_NAME?> | FAQ Category</title>
														...
														<tr class="gradeA">
															...
															<td align="center" style="text-align:center;" class="action-btn001">
																<div class="share-button openHoverAction-class" style="display: block;">
																	...
																	<div class="social show-moreOptions openPops_<?= $data_drv[$i]['iFaqcategoryId']; ?>">
																		<ul>
																			<li class="entypo-twitter" data-network="twitter"><a href="faq_categories_action.php?id=<?=$iUniqueId;?>" data-toggle="tooltip" title="Edit">
