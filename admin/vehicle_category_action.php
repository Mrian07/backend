          ...
          <div id="wrap">
               ...
               <div id="content">
                    <div class="inner">
                         <div class="row">
                              <div class="col-lg-12">
                                   <h2> <?=$langage_lbl_admin['LBL_VEHICLE_CATEGORY_ADMIN'];?></h2>
                                   ...
                                   <form id="vtype" method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-lg-6">
                                                  <select  class="form-control" name = 'vCategory'  id= 'vCategory' >
														...
														<? for ($i = 0; $i < count($db_data1); $i++) { ?>
													   
														<option value = "<?php echo $db_data1[$i]['iVehicleCategoryId'] ?>" <?= ($db_data1[$i]['iVehicleCategoryId'] == $iParentId) ? 'selected' : ''; ?>><?php echo $db_data1[$i]['vCategory_EN']; ?>
														</option>
														<?php 
														$sql="SELECT * FROM  `vehicle_category` WHERE  `iParentId` = '".$db_data1[$i]['iVehicleCategoryId']."' ";
														$db_data2 = $obj->MySQLSelect($sql);
														for ($j = 0; $j < count($db_data2); $j++)
														{
														?>
															<option value = "<?php echo $db_data2[$j]['iVehicleCategoryId'] ?>"><?php echo "&nbsp;&nbsp;|-- ".$db_data2[$j]['vCategory_EN']; ?></option>
														<?
														}
														}
														?>
                                        ...
                                        if($count_all > 0) {
                                          ...
                                          ?>
                                                <div class="row">
                                                   <div class="col-lg-12">
                                                   <label>Category (<?=$vTitle;?>) <span class="red"> *</span></label>
                                         ...
                                         <div class="row">
                                             ...
                                             <div class="col-lg-6">
                                                <? if($vLogo != '') { ?>                                               
                                                 <img src="<?=$tconfig['tsite_upload_images_vehicle_category']."/".$id."/ios/3x_hover_".$vLogo;?>" style="width:100px;height:100px;">
                                                <?}?>
