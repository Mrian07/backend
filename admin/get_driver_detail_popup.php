...
<ul class="<?php echo $db_driver['iDriverId']; ?>">
	<li>
		<h3><strong>Driver Details</strong></h3>
		<label><b>Driver Name :</b><?php echo $generalobjAdmin->clearName($db_driver['FULLNAME']); ?></label>
		<label><b>Driver Email :</b><?php echo $generalobjAdmin->clearEmail($db_driver['vEmail']); ?></label>
	...
	<li>
		<h3><strong>Rider Details</strong></h3>
		<label><b>Rider Name :</b><?php echo $generalobjAdmin->clearName($db_cust['FullName']); ?></label>
