...
$sql = "SELECT COUNT(iUserId) AS Total FROM register_user WHERE eStatus != 'Deleted' $ssql $rdr_ssql";
...
$sql = "SELECT iUserId,CONCAT(vName,' ',vLastName) AS name, vEmail, CONCAT(vPhoneCode,' ',vPhone) AS mobile,tRegistrationDate,eStatus FROM register_user
            ...
            <div id="content">
                <div class="inner">
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="admin-nir-table">
                              <tbody>
                                <tr>
                                    ...
                                    <td width="30%"><a class="add-btn" href="rider_action.php" style="text-align: center;">Add Rider</a></td>
                                </tr>
                              </tbody>
                        </table>
                                                ...
                                                <tbody>
													<?php for($i=0;$i<count($data_drv);$i++) {?>
														...
														<td align="center" style="text-align:center;"><input type="checkbox" id="checkbox" name="checkbox[]" <?php echo $default; ?> value="<?php echo $data_drv[$i]['iUserId']; ?>" />&nbsp;</td>
															<td><? echo $generalobjAdmin->clearName($data_drv[$i]['name']); ?></td>
                    ...
                    <div class="admin-notes">
                            ...
                            <ul>
                                    <li>
                                            Rider module will list all Riders on this page.
                                    </li>
                                    <li>
                                            Administrator can Activate / Deactivate / Delete any rider
                                    </li>
                                    <li>
