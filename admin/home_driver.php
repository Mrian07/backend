...
if($sortby == 1){
  if($order == 0)
  $ord = " ORDER BY vName_EN ASC";
  else
  $ord = " ORDER BY vName_EN DESC";
}

if($sortby == 2){
  if($order == 0)
  $ord = " ORDER BY vDesignation_EN ASC";
  else
  $ord = " ORDER BY vDesignation_EN DESC";
}
...
if($keyword != ''){
    if($option != '') {
        ...
        $ssql.= " AND ( vName_EN LIKE '%".$keyword."%' OR vDesignation_EN LIKE '%".$keyword."%')";
    }
}
                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                          ...
                                          <option value="vName_EN" <?php if ($option == "vName_EN") { echo "selected"; } ?> >Name</option>
                                          <option value="vDesignation_EN" <?php if ($option == 'vDesignation_EN') {echo "selected"; } ?> >Designation</option>
                                    ...
                                    <td width="30%"><a class="add-btn" href="home_driver_action.php" style="text-align: center;">Add Driver</a></td>
                                </tr>
                              </tbody>
                        </table>
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th width="20%"><a href="javascript:void(0);" onClick="Redirect(2,<?php if($sortby == '2'){ echo $order; }else { ?>0<?php } ?>)">Designation <?php if ($sortby == 2) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="gradeA">
                                                        ...
                                                        <td><?= $data_drv[$i]['vImage']; ?></td>
                                                        <td><?= $data_drv[$i]['vName_EN']; ?></td>
                                                        <td><?= $data_drv[$i]['vDesignation_EN']; ?></td>
