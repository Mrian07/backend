    ...
    if ($image_name != "") {
        ...
        if ($flag_error == 1) {
            ...
            $query =" INSERT INTO `".$tbl."` ( `doc_masterid`, `doc_usertype`, `doc_userid`, `ex_date`, `doc_file`, `status`, `edate`) "
                   . "VALUES "
                   . "( '".$_REQUEST['doc_type']."', 'driver', '".$_REQUEST['id']."', '".$expDate."', '".$vImage."', 'Inactive', CURRENT_TIMESTAMP)";
            }
                ...
                <div class="inner">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <a href="driver.php?type=<? echo $_REQUEST['type']?>">
                                            ...
                                            <div class="panel-body">
                                                <?php if ($db_userdoc[$i]['doc_file'] != '') { ?>
                                                    ...
                                                    if ($file_ext == 'is_image') {
                                                        ?>
                                                        <img src = "<?= $tconfig["tsite_upload_driver_doc"] . '/' . $_REQUEST['id'] . '/' . $db_userdoc[$i]['doc_file'] ?>" style="width:200px;cursor:pointer;" alt ="YOUR DRIVING LICENCE" data-toggle="modal" data-target="#myModallicence"/>
                                                    <?php } else { ?>
                                                        <a href="<?= $tconfig["tsite_upload_driver_doc"] . '/' . $_REQUEST['id'] . '/' . $db_userdoc[$i]['doc_file'] ?>" target="_blank"><?php echo $db_userdoc[$i]['doc_name']; ?></a>
                                                    <?php } ?>
                                                    <?php
                                                } else {
