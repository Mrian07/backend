                                            ...
                                            <table width="100%" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr>
                                                 <td> 
                                                                                ...
                                                                                <strong><? echo $db_trip[0]['vCountry']; }?></strong>                                              
                                                                            </td>
                                                  </tr>
                                               </table>                                        
                                        </td> 
                        ...
                        <tr>        
                          ...
                          <td colspan="3" style="border-left: 1px solid #000000;">
							  <table border="0" width="100%" style=="border-top: 1px solid #000000; border-left: 1px solid #000000;" align="left" cellpadding="3" cellspacing="0">          
                                    <tr>      
                                        <th width="15%" height="35" align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 17px; COLOR: #000; FONT-FAMILY: tahoma, Verdana, Arial, Helvetica, sans-serif; border-bottom: 1px solid #000000; border-right: 1px solid #000000;">Ride No</th>
                                        <th width="15%" height="35" align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 17px; COLOR: #000; FONT-FAMILY: tahoma, Verdana, Arial, Helvetica, sans-serif; border-bottom: 1px solid #000000; border-right: 1px solid #000000;">Driver Name</th>
                                        <!--<th height="35" align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 17px; COLOR: #000; FONT-FAMILY: tahoma, Verdana, Arial, Helvetica, sans-serif; border-bottom: 1px solid #000000; border-right: 1px solid #000000;">passenger Name</th>-->
                                        <th width="15%" height="35" align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 17px; COLOR: #000; FONT-FAMILY: tahoma, Verdana, Arial, Helvetica, sans-serif; border-bottom: 1px solid #000000; border-right: 1px solid #000000;">Trip Date</th>
                                                                                <!--<th>Address</th>-->
                                        ...
                                        <th width="10%" height="35" align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 17px; COLOR: #000; FONT-FAMILY: tahoma, Verdana, Arial, Helvetica, sans-serif; border-bottom: 1px solid #000000; border-right: 1px solid #000000;">Driver pay Amount</th>
                                        <!--<th height="35" align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 17px; COLOR: #000; FONT-FAMILY: tahoma, Verdana, Arial, Helvetica, sans-serif; border-bottom: 1px solid #000000; border-right: 1px solid #000000;">Trip Status</th>
                                        ...
                                        <th height="35" align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 17px; COLOR: #000; FONT-FAMILY: tahoma, Verdana, Arial, Helvetica, sans-serif; border-bottom: 1px solid #000000; border-right: 1px solid #000000;">Driver Payment Status</th>-->          
                                    </tr>
                                    <?
                                      if(count($db_trip) > 0){
                                        $tot_fare = 0.00;
