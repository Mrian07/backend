...
<div class="upload-content">
    <h4><?php if($db_user[0]['doc_name']){echo $db_user[0]['doc_name'];}else{ echo 'Vehicle Insurance';} ?></h4>
                    ...
                    <div class="fileupload-preview thumbnail" style="width: 200px; height: 150px; ">
                        <?php if ($db_user[0]['doc_file'] == '') { 
                            ...
                            if ($file_ext == 'is_image') {
							    ?>
                                <img src = "<?= $tconfig["tsite_upload_vehicle_doc_panel"] . '/' . $id[1] . '/' . $db_user[0]['doc_file'] ?>" style="width:200px;" alt ="Licence not found"/>
                            <?php } else { ?>
                                <a href="<?= $tconfig["tsite_upload_vehicle_doc_panel"] . '/' . $id[1] . '/' . $db_user[0]['doc_file'] ?>" target="_blank"><?php echo $db_user[0]['doc_name']; ?></a>
                            <?php } ?>
                        <?php } ?>
                    </div>
                    <div>
