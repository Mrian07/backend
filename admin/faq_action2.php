			...
			<div id="content">
               ...
               <?} ?>
							...
							<form method="post" name="_faq_form" id="_faq_form" action="" enctype="multipart/form-data">
								...
								<? 
								echo $sql = "SELECT * FROM faq_categories WHERE vCode = '".$default_lang."' ORDER BY iDisplayOrder";
								...
								<div class="row">
									...
									<div class="col-lg-6">
										<?
											$temp = 1;
											$query1 = mysql_query("SELECT iDisplayOrder FROM ".$tbl_name." WHERE iFaqcategoryId = ".$faq_cat_id." ORDER BY iDisplayOrder")or die(mysql_error());
											$dataArray = array();
								...
								<? } else{ ?>
										<div class="row">
											...
											<div class="col-lg-6">
												<?
												$temp = 1;
												$query1 = mysql_query("SELECT max(iDisplayOrder) as MAXDORDER FROM ".$tbl_name."  ORDER BY iDisplayOrder")or die(mysql_error());
												$dataArray = array();
												while($res = mysql_fetch_array($query1))
												{
								...
								if($count_all > 0) {
										...
										<div class="row">
											...
											<div class="col-lg-6">
												<input type="text" class="form-control" name="<?=$vTitle_val;?>"  id="<?=$vTitle_val;?>" value="<?=$$vTitle_val;?>" placeholder="FAQ" >
											</div>
										</div>
										<div class="row">
											<div class="col-lg-12">
											...
											<div class="col-lg-12">
												<textarea class="form-control wysihtml5" name="<?=$tAnswer_val;?>"  id="<?=$tAnswer_val;?>" placeholder="Answer" ><?=$$tAnswer_val;?></textarea>
											</div>
										</div>
										<? } 
									} ?>
