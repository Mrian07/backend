<?
	...
	if(isset($_POST['submit'])) {
				...
				if(SITE_TYPE=='Demo')
				{
						header("Location:negative_action.php?id=".$id.'&success=2');
						exit;
				}
		...
		if($id == " "){
			header("Location:negative_area_action.php?success=1");
			
		}
		else{
			header("Location:negative_area_action.php?restricted_id=".$id."&success=1");
		}
...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
	...
	<head>
		<meta charset="UTF-8" />
		<title>Admin | Negative Area <?=$action;?></title>
		...
		<div id="wrap">
			...
			<div id="content">
				<div class="inner">
					<div class="row">
						<div class="col-lg-12">
							<h2><?=$action;?> Negative Area</h2>
							<a href="negative_area.php">
						...
						<div class="form-group">
							...
							<form method="post" action="">
								...
								<div class="row">
									...
									<div class="col-lg-6">
											<select  id="state" onChange="showCity(this.value);" name="vState" class="selectpicker" data-live-search="true">
								...
								<div class="row">
									...
									<div class="col-lg-3">
										<input type="text" class="form-control" name="vAddress"  id="vAddress" value="<?=$vAddress;?>" placeholder="Area address" required>
									</div>
								</div>
