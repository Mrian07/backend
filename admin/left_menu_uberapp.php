            ...
            <ul class="sidebar-menu">
                ...
                <?php if($_SESSION['sess_iGroupId'] == '2') { ?>		
                    <?php if(RIIDE_LATER == 'YES'){ ?>
                        <li class="<?= (isset($script) && $script == 'booking') ? 'active' : ''; ?>"><a href="add_booking.php"><i class="fa fa-motorcycle1" style="margin:2px 0 0;"><img src="images/manual-taxi-icon.png" alt="" /></i> <span>Manual Taxi Dispatch</span> </a></li>
					<?php } ?>
                    <?php if(RIIDE_LATER == 'YES'){ ?>
					...
					<li class="treeview <?= (isset($script) && 
						...
						<ul class="treeview-menu menu_drop_down">
							...
							<li class=""><a href="ride_acceptance_report.php" class="<?= (isset($script) && ($script == 'Driver Accept Report' )) ? 'sub_active' : ''; ?>"><i class="icon-group"></i> Ride Acceptance Report </a></li>   
							<li class=""><a href="driver_trip_detail.php" class="<?= (isset($script) && ($script == 'Driver Trip Detail' )) ? 'sub_active' : ''; ?>"><i class="fa fa-motorcycle"></i> Trip Time Variance </a></li>
						</ul>
					</li>
					...
					<?php if($APP_TYPE == 'UberX'){ ?>
						<li class="treeview <?=(isset($script) && $script == 'PetType' || $script == 'userPets')?'active':'';?>"><a href="#" title="" class="expand "><i class="icon-cogs1" style="margin:3px 0 0;"><img src="images/reports-icon.png" alt="" /></i><span><?php echo $langage_lbl_admin['LBL_PET_TYPE'];?></span></a>
							<ul class="treeview-menu menu_drop_down">
								...
								<li class=""><a href="user_pets.php"><i aria-hidden="true" class="fa fa-motorcycle"></i> <?php echo $langage_lbl_admin['LBL_USER_PETS_ADMIN'];?></a></li>
							</ul>
						</li>
					<?php } ?>
					...
					<?php if($APP_TYPE == 'UberX'){ ?>
							...
							<ul class="treeview-menu menu_drop_down">
								...
								<li class="treeview <?= (isset($script) && ($script == 'language_label' || $script == 'language_label_other')) ? 'active' : '';?>"><a href="#" title="" ><i class="fa fa-language"></i> Language Label</a>
									<ul class="treeview-menu menu_drop_down">
										...
										<li><a href="languages_admin.php" class="<?= (isset($script) && ($script == 'language_label_other' )) ? 'sub_active' : ''; ?>"><i class="fa fa-dot-circle-o"></i> Ride Label </a></li>
									</ul>
								</li>
								<? } ?>
						...
						<li class="treeview <?= (isset($script) && 
							...
							<ul class="treeview-menu menu_drop_down">
								...
								<?php if($APP_TYPE != 'UberX'){ ?>
									<li><a href="make.php" class="<?= (isset($script) && ($script == 'Make' )) ? 'sub_active' : ''; ?>"><i class="fa fa-motorcycle"></i> <?php echo $langage_lbl_admin['LBL_CAR_MAKE_ADMIN'];?> </a></li>
									<li><a href="model.php" class="<?= (isset($script) && ($script == 'Model' )) ? 'sub_active' : ''; ?>"><i class="fa fa-motorcycle"></i> <?php echo $langage_lbl_admin['LBL_CAR_MODEL_ADMIN'];?>  </a></li>
								<?php } ?>
