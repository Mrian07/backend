...
/*$query_driver = "SELECT uw.*,rd.* FROM user_wallet as uw LEFT JOIN register_driver as rd ON rd.iRefUserId=uw.iUserId WHERE uw.eUserType='".$type."' AND uw.iUserId='".$id."' AND uw.eFor = 'Referrer' AND rd.eRefType = '".$type."' GROUP BY uw.iUserId";
$result_driver = $obj->MySQLSelect($query_driver);	

$query_reider = "SELECT uw.*,urd.vName,urd.vLastName,urd.dRefDate FROM user_wallet as uw LEFT JOIN register_user as urd ON urd.iRefUserId=uw.iUserId WHERE uw.eUserType='".$type."' AND uw.iUserId='".$id."' AND uw.eFor = 'Referrer' AND urd.eRefType = '".$type."' GROUP BY uw.iUserId";
