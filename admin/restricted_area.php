...
$ord = ' ORDER BY ra.iRestrictedNegativeId DESC';
if($sortby == 1){
  if($order == 0)
...
if($keyword != ''){
    if($option != '') {
        ...
        $ssql.= " AND (c.vCountry LIKE '%".$generalobjAdmin->clean($keyword)."%' OR st.vState LIKE '%".$generalobjAdmin->clean($keyword)."%' OR ct.vCity LIKE '%".$generalobjAdmin->clean($keyword)."%' OR ra.vAddress LIKE '%".$generalobjAdmin->clean($keyword)."%' OR ra.eStatus LIKE '%".$generalobjAdmin->clean($keyword)."%')";
    }
}
...
$sql = "SELECT ra.iRestrictedNegativeId, c.vCountry, st.vState, ct.vCity, ra.vAddress, ra.eRestrictType, ra.eType, ra.eStatus FROM ".$tbl_name." AS ra
		LEFT JOIN country AS c ON c.iCountryId=ra.iCountryId
		LEFT JOIN state AS st ON st.iStateId=ra.iStateId
		LEFT JOIN city AS ct ON ct.iCityId=ra.iCityId
                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                          ...
                                          <option value="st.vState" <?php if ($option == 'st.vState') {echo "selected"; } ?> >State</option>
                                          <option value="ct.vCity" <?php if ($option == 'ct.vCity') {echo "selected"; } ?> >City</option>
                                          <option value="ra.vAddress" <?php if ($option == 'ra.vAddress') {echo "selected"; } ?> >Address</option>
                                            ...
                                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
												<thead>
													<tr>
														...
														<th width="15%"><a href="javascript:void(0);" onClick="Redirect(1,<?php if($sortby == '1'){ echo $order; }else { ?>0<?php } ?>)">Country <?php if ($sortby == 1) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
														<th width="15%"><a href="javascript:void(0);" onClick="Redirect(2,<?php if($sortby == '2'){ echo $order; }else { ?>0<?php } ?>)">State <?php if ($sortby == 2) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
														<th width="15%"><a href="javascript:void(0);" onClick="Redirect(3,<?php if($sortby == '3'){ echo $order; }else { ?>0<?php } ?>)">City <?php if ($sortby == 3) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
														<th width="15%"><a href="javascript:void(0);" onClick="Redirect(4,<?php if($sortby == '4'){ echo $order; }else { ?>0<?php } ?>)">Address <?php if ($sortby == 4) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
													...
													<?
														...
														if($count_all > 0) {
															...
															<tr class="gradeA">
																...
																<td><?php echo ($db_data[$i]['vCountry'] != '') ? $db_data[$i]['vCountry'] : '---';?></td>
																<td><?php echo ($db_data[$i]['vState'] != '') ? $db_data[$i]['vState'] : '---';?></td>
																<td><?php echo ($db_data[$i]['vCity'] != '') ? $db_data[$i]['vCity'] : '---';?></td>
																<td><?php echo ($db_data[$i]['vAddress'] != '') ? $db_data[$i]['vAddress'] : '---';?></td>
                                                                ...
                                                                <div class="share-button openHoverAction-class" style="display: block;">
                                                                    ...
                                                                    <div class="social show-moreOptions openPops_<?= $db_data[$i]['iRestrictedNegativeId']; ?>">
                                                                        <ul>
