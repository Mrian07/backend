...
$sql = "SELECT ad.iAdminId,ad.vFirstName,ad.vLastName,ad.vEmail,ad.vContactNo,ad.eStatus,ag.vGroup,ad.eDefault FROM administrators AS ad
        LEFT JOIN admin_groups AS ag ON ad.iGroupId=ag.iGroupId
        WHERE ad.eStatus != 'Deleted' $ssql $ord LIMIT $start, $per_page";
                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <td width="8%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                          ...
                                          <option value="concat(ad.vFirstName,' ',ad.vLastName)" <?php if ($option == "concat(ad.vFirstName,' ',ad.vLastName)") { echo "selected"; } ?> >Name</option>
