                ...
                <form name="show_export_modal_form" id="show_export_modal_form" action="" method="post" class="form-horizontal form-box remove-margin" enctype="multipart/form-data">
                    <div class="form-box-content">
                        <div class="form-group">
                            <label for="title" class="control-label col-md-3">Type *</label>
                            <div class="col-md-6"><div class="input-group"><input type="radio" name="exportType" value="XLS" checked>XLS &nbsp;<input type="radio" name="exportType" value="PDF">PDF  </div></div>
                        </div>
                    </div>
                </form>
            </div>
