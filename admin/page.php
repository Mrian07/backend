...
$sql = "SELECT COUNT(iPageId) AS Total FROM pages WHERE eStatus != 'Deleted' $ssql";
...
//$sql = "SELECT * FROM ".$tbl_name."  WHERE eStatus != 'Deleted' $ssql $ord LIMIT $start, $per_page ";
 $sql = "SELECT iPageId,vPageName,vTitle,vPageTitle_$default_lang,tPageDesc_$default_lang FROM ".$tbl_name." where ipageId NOT IN('5','20','21','20')  $ssql $ord LIMIT $start, $per_page ";
                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                          ...
                                          <option  value="vPageName" <?php if ($option == "vPageName") { echo "selected"; } ?> >Name</option>
                                          <option value="<?='vPageTitle_'.$default_lang ?>" <?php if ($option == "vPageTitle_.$default_lang") {echo "selected"; } ?> >Page Title</option>
                                    ...
                                    <td width="12%">
                                      ...
                                      <input type="button" value="Reset" class="btnalt button11" onClick="window.location.href='page.php'"/>
                                    </td>
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th width="20%"><a href="javascript:void(0);" onClick="Redirect(2,<?php if($sortby == '2'){ echo $order; }else { ?>0<?php } ?>)">Page Title <?php if ($sortby == 2) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
                                                        
                                                        
                                                        <th width="8%" align="center" style="text-align:center;"><!--<a href="javascript:void(0);" onClick="Redirect(4,<?php if($sortby == '4'){ echo $order; }else { ?>0<?php } ?>)"> <?php if ($sortby == 4) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a>-->
														Edit</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="gradeA">
                                                        ...
                                                        <td><?= $generalobjAdmin->clearEmail($data_drv[$i]['vPageTitle_'.$default_lang]); ?></td>
                                                            ...
                                                            <td align="center" style="text-align:center;" class="action-btn001">
																...
																<div class="share-button openHoverAction-class" style="display: block;">
																			...
																			<label class="entypo-twitter" data-network="twitter"><a href="page_action.php?id=<?= $data_drv[$i]['iPageId']; ?>" data-toggle="tooltip" title="Edit">
