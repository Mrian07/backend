...
$sql = "SELECT COUNT(iStateId) AS Total FROM state AS s
LEFT JOIN country AS c ON c.iCountryId = s.iCountryId
WHERE s.eStatus != 'Deleted' $ssql";
...
$sql = "SELECT s.iStateId, s.vState, c.iCountryId,c.vCountry,s.vStateCode,s.eStatus
FROM state AS s
LEFT JOIN country AS c ON c.iCountryId = s.iCountryId
WHERE s.eStatus !=  'Deleted' $ssql $ord LIMIT $start, $per_page ";
            ...
            <div id="content">
                <div class="inner">
                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                          ...
                                          <option  value="s.vState" <?php if ($option == "vState") { echo "selected"; } ?> >State</option>
                                          <option value="s.vStateCode" <?php if ($option == 'vStateCode') {echo "selected"; } ?> >Code</option>
                                    ...
                                    <td width="12%">
                                      ...
                                      <input type="button" value="Reset" class="btnalt button11" onClick="window.location.href='state.php'"/>
                                    </td>
                                    <td width="30%"><a class="add-btn" href="state_action.php" style="text-align: center;">Add State</a></td>
                                </tr>
                              </tbody>
                        </table>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th width="20%"><a href="javascript:void(0);" onClick="Redirect(1,<?php if($sortby == '1'){ echo $order; }else { ?>0<?php } ?>)">Country <?php if ($sortby == 1) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
														  <th width="20%"><a href="javascript:void(0);" onClick="Redirect(2,<?php if($sortby == '2'){ echo $order; }else { ?>0<?php } ?>)">State <?php if ($sortby == 2) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
                                                        <th width="20%"><a href="javascript:void(0);" onClick="Redirect(3,<?php if($sortby == '3'){ echo $order; }else { ?>0<?php } ?>)">State Code <?php if ($sortby == 3) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="gradeA">
                                                        <td align="center" style="text-align:center;"><input type="checkbox" id="checkbox" name="checkbox[]" <?php echo $default; ?> value="<?php echo $data_drv[$i]['iStateId']; ?>" />&nbsp;</td>
                                                        <td><?= $data_drv[$i]['vCountry']; ?></td>
														<td><?= $data_drv[$i]['vState']; ?></td>
                                                        <td><?= $data_drv[$i]['vStateCode']; ?></td>
                                                        ...
                                                        <td align="center" style="text-align:center;">
                                                            ...
                                                            <td align="center" style="text-align:center;" class="action-btn001">
                                                                <div class="share-button openHoverAction-class" style="display: block;">
                                                                    ...
                                                                    <div class="social show-moreOptions openPops_<?= $data_drv[$i]['iStateId']; ?>">
                                                                        <ul>
                                                                            <li class="entypo-twitter" data-network="twitter"><a href="state_action.php?id=<?= $data_drv[$i]['iStateId']; ?>" data-toggle="tooltip" title="Edit">
                                                                                <img src="img/edit-icon.png" alt="Edit">
                                                                            </a></li>
                                                                            <?php if ($data_drv[$i]['eDefault'] != 'Yes') { ?>
                                                                            <li class="entypo-facebook" data-network="facebook"><a href="javascript:void(0);" onclick="changeStatus('<?php echo $data_drv[$i]['iStateId']; ?>','Inactive')"  data-toggle="tooltip" title="Make Active">
                                                                                <img src="img/active-icon.png" alt="<?php echo $data_drv[$i]['eStatus']; ?>" >
                                                                            </a></li>
                                                                            <li class="entypo-gplus" data-network="gplus"><a href="javascript:void(0);" onclick="changeStatus('<?php echo $data_drv[$i]['iStateId']; ?>','Active')" data-toggle="tooltip" title="Make Inactive">
                                                                                <img src="img/inactive-icon.png" alt="<?php echo $data_drv[$i]['eStatus']; ?>" >	
                                                                            </a></li>
                                                                            <li class="entypo-gplus" data-network="gplus"><a href="javascript:void(0);" onclick="changeStatusDelete('<?php echo $data_drv[$i]['iStateId']; ?>')"  data-toggle="tooltip" title="Delete">
                    ...
                    <div class="admin-notes">
                            ...
                            <ul>
                                    <li>
                                            State module will list all countries on this page.
                                    </li>
                                    <li>
