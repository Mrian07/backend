          ...
          <div id="wrap">
               ...
               <div id="content">
                    <div class="inner">
						<div class="row">
                            <div class="col-lg-12">
                                 <h2><?= $action; ?> Rider <?= $vName; ?> <?= $vLastName; ?></h2>
						   ...
						   <form method="post" action="" enctype="multipart/form-data" id="_rider_form" name="_rider_form">
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-lg-6"  style="width:50%">
												 <input type="text" class="form-select-2" id="code" readonly name="vPhoneCode" value="<?= $vPhoneCode ?>">
                                                  <input type="text" pattern = "[0-9]{1,}" title="Please enter proper mobile number."  class="mobile-text form-control" name="vPhone" id="vPhone" value="<?= $vPhone; ?>" placeholder="Phone">
                                             </div>
                                        </div>
										...
										<div class="row">
											<div class="col-lg-12">
												<input type="submit" class="btn btn-default" name="submit" id="submit" value="<?= $action; ?> Rider" >
