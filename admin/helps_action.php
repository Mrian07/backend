							...
							<form method="post" name="_helps_form" id="_helps_form" action="" enctype="multipart/form-data">
								...
								<div class="row">
									...
									<div class="col-lg-6">
										<?
											$temp = 1;
											$query1 = mysql_query("SELECT iDisplayOrder FROM ".$tbl_name." WHERE iHelpsId = ".$id." ORDER BY iDisplayOrder")or die(mysql_error());
											$dataArray = array();
								...
								<? } else{ ?>
										<div class="row">
											...
											<div class="col-lg-6">
												<?
												$temp = 1;
												$query1 = mysql_query("SELECT max(iDisplayOrder) as MAXDORDER FROM ".$tbl_name)or die(mysql_error());
												$dataArray = array();
