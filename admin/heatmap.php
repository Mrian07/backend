    ...
    <div class="inner" style="min-height: 900px;">
	  ...
	  <div class="admin-notes">
			...
			<? if($APP_TYPE != "UberX"){?>
				<ul>
					<li>
						Maximum trips area showing in blue color with grediants.
					</li>
					<li>
						Online riders with maximum 5 minutes are showing as green color with grediants.
					</li>
					<li>
						Toggle will show or hide the grediants from the map.
					</li>
					<li>
						Opacity will show the grediants part less visible and vice versa.
					</li>
				</ul>
			<? }else{ ?>
				<ul>
					<li>
						Maximum Jobs area showing in blue color with grediants.
					</li>
					<li>
						Online users with maximum 5 minutes are showing as green color with grediants.
					</li>
					<li>
						Toggle will show or hide the grediants from the map.
					</li>
...
$sql = "SELECT iTripId,iUserId,iDriverId,tStartLat,tStartLong
              FROM trips
                WHERE tStartLat !='' AND tStartLong !='' ";
