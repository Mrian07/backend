...
<nav>
  ...
  <ul id="listMenu">
    <span class="desktop">
        ...
        <p><?php echo $db_data[0]['vName'].' '.$db_data[0]['vLastName']; ?></p>
		<?php } ?>
        </div>
			  ...
			  <?php }else{
						if($user == 'driver'){?>
							...
							<?php }else{?>
								...
								<li><a href="add_services.php" class="<?=(isset($script) && $script == 'My Availability')?'active':'';?>"><b><img alt="" src="assets/img/my-profile-icon.png"></b><span><?=$langage_lbl['LBL_HEADER_MY_AVAILABILITY'];?></span></a></li>
							<?php } ?>
				  ...
				  <?php }else if($user == 'company'){ ?>
							...
							<?php if($APP_TYPE != 'UberX'){ ?>
							<li><a href="vehicle" class="<?=(isset($script) && $script == 'Vehicle')?'active':'';?>"><b><img alt="" src="assets/img/my-profile-icon.png"></b><span><?=$langage_lbl['LBL_HEADER_TOPBAR_VEHICLES'];?></span></a></li>
							<?php } ?>
