                ...
                <span>
                    <?php
						...
						<?php }else{?>
							...
							<a href="add_services.php" class="<?=(isset($script) && $script == 'My Availability')?'active':'';?>"><i class="fa fa-car" aria-hidden="true"></i><?=$langage_lbl['LBL_HEADER_MY_AVAILABILITY'];?></a>


						<?php } ?>
						<a href="driver-trip" class="<?=(isset($script) && $script == 'Trips')?'active':'';?>"><i class="fa fa-calendar" aria-hidden="true"></i><?=$langage_lbl['LBL_HEADER_TOPBAR_TRIPS_TEXT'];?></a>
						<a href="payment-request" class="<?=(isset($script) && $script == 'Payment Request')?'active':'';?>"><i class="fa fa-usd" aria-hidden="true"></i><?=$langage_lbl['LBL_HEADER_MY_EARN']; ?></a>
