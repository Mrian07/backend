...
<div id="top-part" class="<?=$col_class;?>">
    <div class="top-part-inner">
        ...
        <div class="contact-number-email"><span><img src="assets/img/phone-icon1.png" alt="">123-456-7890</span>
        <span><img src="assets/img/mgs-icon.png" alt=""><a href="#">info@uberapp.com</a></span></div>
        <div class="logo"><a href="index.php"><img src="assets/img/logo2.jpg" alt=""></a></div>  
        ...
        <?php
			...
			<?php if($user != "") { 
				...
				<span><?=$langage_lbl['LBL_HEADER_WELCOME'];?><br /><a href="profile.php">
						<?php 
							if($_SESSION['sess_user'] != 'company')
                    ...
                    <?php
                        ...
                        <li><a href="mytrip" class="<?=(isset($script) && $script == 'Trips')?'active':'';?>"><i class="fa fa-calendar" aria-hidden="true"></i><?=$langage_lbl['LBL_HEADER_TOPBAR_TRIPS'];?></a></li>
        ...
        <?php
			...
			<!--div class="top-right-button">
				<span>
                <a href="sign-up-rider" ><? //=$langage_lbl['LBL_HEADER_TOPBAR_SIGN_UP_TO_RIDE']; ?></a>
                <a class="active" href="sign-up"><? //=$langage_lbl['LBL_HEADER_TOPBAR_BECOME_A_DRIVER']; ?></a>
				</span>
			</div-->
			<?php
			}
