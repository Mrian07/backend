            ...
            <div class="home-hero-page-left" style="background: rgba(0, 0, 0, 0) url('<?=$tconfig["tsite_upload_page_images"].$homepage_banner["vImage"];?>') no-repeat scroll center top / cover ">
                <div class="home-hero-page-left-text"> 
                    <span>
						...
						<?}else{?>
							 <a href="<?=$link_page?>"><?php echo $langage_lbl['LBL_GET_STARTED'];?>&nbsp;&nbsp;<i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                ...
                <div class="home-hero-page-right-text">
                    <span>
						<?if($_SESSION['sess_iUserId'] == ""){?>
							...
							<a href="sign-up-rider"> <?=$langage_lbl['LBL_HOME_SIGN_UP']; ?>&nbsp;&nbsp;<i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
						<?}else{?>
							<p><?=$langage_lbl['LBL_HOME_RIDING_TXT_LOGIN']; ?></p>
							<a href="<?=$link_page?>"> <?=$langage_lbl['LBL_GET_STARTED']; ?>&nbsp;&nbsp;<i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
						<?}?>
                    </span>
                </div>
