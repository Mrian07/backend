...
<?php 
	...
	$sql="select * from home_driver where eStatus='Active' order by rand() limit 4";
		...
		<?php
			...
			?>
				<div id="box-2" class="box"> <b>
					<img width="290px" id="image-1" src="<?=$tconfig["tsite_upload_images"].$db_home_drv[$i]['vImage']?>"/></b>
