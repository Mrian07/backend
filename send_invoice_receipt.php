    ...
    if($db_vtype[0]['vehcat'] != ""){
       ...
       $car = $db_vtype[0]['vVehicleType'];
					...
					<tbody>
						<tr style="vertical-align:middle;text-align:left;width:100%;padding:0" align="left">
							...
							<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:middle;text-align:left;display:table-cell;width:100%;padding:5px 5px 5px" align="left" valign="middle">
								<span style="padding-bottom:5px;display:inline-block">This trip has been canceled by driver. Reason: '.$db_trip[0]['vCancelReason'].'</span>
							</td>
						</tr>
					</tbody>
				</table>';
		...
		if($db_trip[0]['fDiscount']!="" && $db_trip[0]['fDiscount'] != 0){
			...
			$discount_area='<tr style="vertical-align:top;text-align:left;width:100%;padding:0" align="left">
			<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:left;display:table-cell;width:300px;color:#808080;padding:4px" align="left" valign="top">Promo Code Discount</td>
			<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:right;display:table-cell;width:90px;white-space:nowrap;padding:4px" align="right" valign="top"> - '.$discount_fare.'</td>
			</tr>';
		}
		$minimum_fare ="";
		if($db_trip[0]['fMinFareDiff']!="" && $db_trip[0]['fMinFareDiff'] > 0){
			...
			$minimum_fare='<tr style="vertical-align:top;text-align:left;width:100%;padding:0;border-top:1px;border-bottom-width:1px;border-bottom-color:#f0f0f0;border-bottom-style:solid;" align="left">
			<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:left;display:table-cell;width:300px;color:#808080;padding:4px" align="left" valign="top"> '.$generalobj->trip_currency($minimum_farePrice,$db_trip[0]['fRatio_'.$tripcurname],$tripcurname).' '.$vLabel_user_mail['LBL_MINIMUM'].'</td>
			<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:right;display:table-cell;width:90px;white-space:nowrap;padding:4px" align="right" valign="top">'.$generalobj->trip_currency($db_trip[0]['fMinFareDiff'],$db_trip[0]['fRatio_'.$tripcurname],$tripcurname).'</td>
			</tr>';
		}
								...
								<tbody>
									<tr style="vertical-align:top;text-align:left;width:100%;background-color:rgb(250,250,250);padding:0" align="left" bgcolor="rgb(250,250,250)">
										...
										<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:right;display:inline-block;width:299px;border-radius:0 3px 0 0;background-color:#fafafa;padding:26px 10px 20px" align="right" bgcolor="#FAFAFA" valign="top">
											<span style="vertical-align:top;text-align:right;font-size:11px;color:#999999;text-transform:uppercase;padding-right:10px">Ride Number:'.$Data[0]['ridenum'].'</span> <BR/>
											<span style="padding-right:15px;line-height:10px;font-size:13px;font-weight:normal;color:#b2b2b2">'.$vLabel_user_mail['LBL_THANKS_FOR_CHOOSING_TXT_ADMIN'].' '.$Data[0]['ProjectName'].', '.$Data[0]['rider'].'</span>
										</td>
									</tr>
								</tbody>
							</table>
									...
									<tr style="vertical-align:top;text-align:left;width:100%;padding:0" align="left">
										...
										<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:left;display:inline-block;width:300px;padding:10px" align="left" valign="top">
											<span style="display:block;padding:0px 8px 0 10px">
												...
												<table style="border-spacing:0;border-collapse:collapse;vertical-align:top;text-align:left;margin-top:15px;width:auto;padding:0">
													<tbody>';
														if($eFareType != 'Fixed' && $eFareType != 'Hourly')
														{
														$mailcont_member .= '
														<tr style="vertical-align:top;text-align:left;width:100%;padding:0" align="left">
															<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:left;display:table-cell;width:300px;color:#808080;padding:4px" align="left" valign="top">
														...
														{
														$mailcont_member .= '<tr style="vertical-align:top;text-align:left;border-bottom-width:1px;border-bottom-color:#f0f0f0;border-bottom-style:solid;width:100%;padding:0" align="left">
															<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:left;display:table-cell;width:300px;color:#808080;padding:4px 4px 5px" align="left" valign="top">
																'.$vLabel_user_mail['LBL_Total_Fare'].'
															</td>
															<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:right;display:table-cell;width:90px;white-space:nowrap;padding:4px 4px 5px" align="right" valign="top">'.$Data[0]['total_amt'].'</td>
														</tr>';
														}
														if($db_trip[0]['fWalletDebit'] > 0)
														{
															$mailcont_member .= '<tr style="vertical-align:top;text-align:left;width:100%;padding:0" align="left">
																<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:left;display:table-cell;width:300px;color:#808080;padding:4px" align="left" valign="top">
																	'.$vLabel_user_mail['LBL_WALLET_DEBIT_MONEY'].'
																</td>
																<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:right;display:table-cell;width:90px;white-space:nowrap;padding:4px" align="right" valign="top">- '.$generalobj->trip_currency($db_trip[0]['fWalletDebit'],$db_trip[0]['fRatio_'.$tripcurname],$tripcurname).'</td>
															</tr>';
														}
														...
														$mailcont_member .= '<tr style="vertical-align:top;text-align:left;width:100%;padding:0" align="left">
															...
															<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:right;display:table-cell;width:90px;white-space:nowrap;padding:4px" align="right" valign="top">'.$generalobj->trip_currency($db_trip[0]['fSurgePriceDiff'],$db_trip[0]['fRatio_'.$tripcurname],$tripcurname).'</td>
														</tr>';
														}
														...
														$mailcont_member .= '<tr style="vertical-align:top;text-align:left;width:100%;padding:0" align="left">
															<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:left;display:table-cell;width:300px;color:#808080;padding:4px" align="left" valign="top">
																'.$vLabel_user_mail['LBL_VISIT_FEE'].'
															</td>
															<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:right;display:table-cell;width:90px;white-space:nowrap;padding:4px" align="right" valign="top">'.$generalobj->trip_currency($db_trip[0]['fVisitFee'],$db_trip[0]['fRatio_'.$tripcurname],$tripcurname).'</td>
														</tr>';
														}
														...
														$mailcont_member .= '<tr style="vertical-align:top;text-align:left;width:100%;padding:0" align="left">
															<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:left;display:table-cell;width:300px;color:#808080;padding:4px" align="left" valign="top">
																'.$vLabel_user_mail['LBL_MATERIAL_FEE'].'
															</td>
															<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:right;display:table-cell;width:90px;white-space:nowrap;padding:4px" align="right" valign="top">'.$generalobj->trip_currency($db_trip[0]['fMaterialFee'],$db_trip[0]['fRatio_'.$tripcurname],$tripcurname).'</td>
														</tr>';
														}
														...
														$mailcont_member .= '<tr style="vertical-align:top;text-align:left;width:100%;padding:0" align="left">
															<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:left;display:table-cell;width:300px;color:#808080;padding:4px" align="left" valign="top">
																'.$vLabel_user_mail['LBL_MISC_FEE'].'
															</td>
															<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:right;display:table-cell;width:90px;white-space:nowrap;padding:4px" align="right" valign="top">'.$generalobj->trip_currency($db_trip[0]['fMiscFee'],$db_trip[0]['fRatio_'.$tripcurname],$tripcurname).'</td>
														</tr>';
														}
														...
														$mailcont_member .= '<tr style="vertical-align:top;text-align:left;width:100%;padding:0" align="left">
															<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:left;display:table-cell;width:300px;color:#808080;padding:4px" align="left" valign="top">
																'.$vLabel_user_mail['LBL_PROVIDER_DISCOUNT'].'
															</td>
															<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:right;display:table-cell;width:90px;white-space:nowrap;padding:4px" align="right" valign="top">- '.$generalobj->trip_currency($db_trip[0]['fDriverDiscount'],$db_trip[0]['fRatio_'.$tripcurname],$tripcurname).'</td>
														</tr>';
														}
														
														$mailcont_member .=$minimum_fare.'
														<tr style="vertical-align:top;text-align:left;font-weight:bold;width:100%;padding:0" align="left">
															...
															<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:right;display:table-cell;width:90px;white-space:nowrap;padding:5px 4px 4px" align="right" valign="top">'.$Data[0]['total_amt'].'</td>
														</tr>';
														...
														$mailcont_member .= '<tr style="vertical-align:top;text-align:left;width:100%;padding:0" align="left">
															...
															<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:right;display:table-cell;width:90px;white-space:nowrap;padding:4px" align="right" valign="top">'.$generalobj->trip_currency($db_trip[0]['fTipPrice']).'</td>
														</tr>';
														}
							...
							<table style="border-spacing:0;border-collapse:collapse;vertical-align:middle;text-align:left;width:100%;max-width:640px;border-bottom-width:1px;border-bottom-color:#f0f0f0;border-bottom-style:solid;padding:0">
								<tbody>
									<tr style="vertical-align:middle;text-align:left;width:100%;padding:0" align="left">
										...
										<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:middle;text-align:left;display:inline-block;width:50%;height:100%;padding:0px 0px 0px" align="left" valign="middle">
											<table style="border-spacing:0;border-collapse:collapse;vertical-align:middle;text-align:left;width:100%;max-width:640px;display:block;padding:20px 0px 0px">
    ...
    $mailcont_member_trips_img ='';
      ...
      $minimum_fare ="";
  		 if($db_trip[0]['fMinFareDiff']!="" && $db_trip[0]['fMinFareDiff'] > 0){
			...
			$minimum_farePrice=$db_trip[0]['iBaseFare']+$db_trip[0]['fPricePerKM']+$db_trip[0]['fPricePerMin']+$db_trip[0]['fMinFareDiff'];
  			$minimum_fare='<tr style="vertical-align:top;text-align:left;width:100%;padding:0;border-top:1px;border-bottom-width:1px;border-bottom-color:#f0f0f0;border-bottom-style:solid;" align="left">
  			<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:left;display:table-cell;width:300px;color:#808080;padding:4px" align="left" valign="top"> '.$generalobj->trip_currency($minimum_farePrice).' Minimum Fare</td>
  			<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:right;display:table-cell;width:90px;white-space:nowrap;padding:4px" align="right" valign="top">'.$minimum_fare_diff.'</td>
  			</tr>';
  		}
													...
													<table style="border-spacing:0;border-collapse:collapse;vertical-align:top;text-align:left;margin-top:15px;width:auto;padding:0">
														...
														if($db_trip[0]['fWalletDebit'] > 0)
														{
															$mailcont_member .= '<tr style="vertical-align:top;text-align:left;width:100%;padding:0" align="left">
																...
																<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:right;display:table-cell;width:90px;white-space:nowrap;padding:4px" align="right" valign="top">- '.$generalobj->trip_currency($db_trip[0]['fWalletDebit']).'</td>
															</tr>';
														}
														if($db_trip[0]['fSurgePriceDiff'] > 0)
														{
														$mailcont_member .= '<tr style="vertical-align:top;text-align:left;width:100%;padding:0" align="left">
															...
															<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:right;display:table-cell;width:90px;white-space:nowrap;padding:4px" align="right" valign="top">'.$generalobj->trip_currency($db_trip[0]['fSurgePriceDiff']).'</td>
														</tr>';
														}
															...
															<tr style="vertical-align:top;text-align:left;border-bottom-width:1px;border-bottom-color:#f0f0f0;width:100%;padding:0" align="left">
																<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:left;display:table-cell;width:300px;color:#808080;padding:4px 4px 5px" align="left" valign="top">
																	'.$vLabel_admin_mail['LBL_PLATFORM_FREES_TXT'].'
																</td>
																<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:right;display:table-cell;width:90px;white-space:nowrap;padding:4px 4px 5px" align="right" valign="top">- '.$Data[0]['fCommision'].'</td>
															</tr>';
															...
															if($db_trip[0]['fVisitFee'] > 0)
															{
																$mailcont_member .= '<tr style="vertical-align:top;text-align:left;width:100%;padding:0" align="left">
																	<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:left;display:table-cell;width:300px;color:#808080;padding:4px" align="left" valign="top">
																		'.$vLabel_admin_mail['LBL_VISIT_FEE'].'
																	</td>
																	<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:right;display:table-cell;width:90px;white-space:nowrap;padding:4px" align="right" valign="top">'.$generalobj->trip_currency($db_trip[0]['fVisitFee']).'</td>
																</tr>';
															}
															if($db_trip[0]['fMaterialFee'] > 0)
															{
																$mailcont_member .= '<tr style="vertical-align:top;text-align:left;width:100%;padding:0" align="left">
																	<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:left;display:table-cell;width:300px;color:#808080;padding:4px" align="left" valign="top">
																		'.$vLabel_admin_mail['LBL_MATERIAL_FEE'].'
																	</td>
																	<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:right;display:table-cell;width:90px;white-space:nowrap;padding:4px" align="right" valign="top">'.$generalobj->trip_currency($db_trip[0]['fMaterialFee']).'</td>
																</tr>';
															}
															if($db_trip[0]['fMiscFee'] > 0)
															{
																$mailcont_member .= '<tr style="vertical-align:top;text-align:left;width:100%;padding:0" align="left">
																	<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:left;display:table-cell;width:300px;color:#808080;padding:4px" align="left" valign="top">
																		'.$vLabel_admin_mail['LBL_MISC_FEE'].'
																	</td>
																	<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:right;display:table-cell;width:90px;white-space:nowrap;padding:4px" align="right" valign="top">'.$generalobj->trip_currency($db_trip[0]['fMiscFee']).'</td>
																</tr>';
															}
															if($db_trip[0]['fDriverDiscount'] > 0)
															{
																$mailcont_member .= '<tr style="vertical-align:top;text-align:left;width:100%;padding:0" align="left">
																	<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:left;display:table-cell;width:300px;color:#808080;padding:4px" align="left" valign="top">
																		'.$vLabel_admin_mail['LBL_PROVIDER_DISCOUNT'].'
																	</td>
																	<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:right;display:table-cell;width:90px;white-space:nowrap;padding:4px" align="right" valign="top">- '.$generalobj->trip_currency($db_trip[0]['fDriverDiscount']).'</td>
																</tr>';
															}
