						...
						<form id="frm1" method="post" onSubmit="return editPro('login')" enctype="multipart/form-data">
							...
							<div id="hide-profile-div" class="row col-md-12">
								...
								<legend class="lable-b">	<h4 class="headind-a1"><?=$langage_lbl['LBL_PREFERENCES_TEXT']?>: </h4></legend>
										...
										<div class="div-img1"> <? foreach($data_driver_pref as $val){?>
							...
							<div class="driver-action-page-right validation-form">
								<div class="row-a1">
									<div class="col-md-6">
										<span>
											<label><?=$langage_lbl['LBL_YOUR_FIRST_NAME']; ?></label>
											<input type="text" class="driver-action-page-input" name="vName"  id="vName" value="<?= $generalobj->cleanall(htmlspecialchars($vName)); ?>" placeholder="First Name" required>
										</span> 
									</div>
									<div class="col-md-6">
										<span>
											<label><?=$langage_lbl['LBL_YOUR_LAST_NAME']; ?></label>	
											<input type="text" class="driver-action-page-input" name="vLastName"  id="vLastName" value="<?= $generalobj->cleanall(htmlspecialchars($vLastName)); ?>" placeholder="Last Name" required>
										</span> 
									</div>
									<div class="col-md-6">
										<span>
									...
									<? }else{ ?>
										<input name="vLang" type="hidden" class="create-account-input" value="<?= $db_lang[0]['vCode'] ?>" id="vCurrencyDriver"/>
									<? } ?> 
									<div class="col-md-6">
										<span>
											<label><?=$langage_lbl['LBL_PROFILE_RIDER_PASSWORD']; ?></label>
